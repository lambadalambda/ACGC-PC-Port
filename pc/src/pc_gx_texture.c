...
static void texobj_set_image_ptr(u32* o, const void* image_ptr) {
    uintptr_t addr = (uintptr_t)image_ptr;
    o[TEXOBJ_IMAGE_PTR] = (u32)addr;
#if UINTPTR_MAX > 0xFFFFFFFFu
    o[TEXOBJ_IMAGE_PTR_HI] = (u32)(addr >> 32);
#else
    o[TEXOBJ_IMAGE_PTR_HI] = 0;
#endif
}

static void* texobj_get_image_ptr(const u32* o) {
    uintptr_t addr = (uintptr_t)o[TEXOBJ_IMAGE_PTR];
#if UINTPTR_MAX > 0xFFFFFFFFu
    addr |= (uintptr_t)o[TEXOBJ_IMAGE_PTR_HI] << 32;
#endif
    return (void*)addr;
}

static void tlutobj_set_data_ptr(u32* o, const void* data_ptr) {
    uintptr_t addr = (uintptr_t)data_ptr;
    o[TLUTOBJ_DATA] = (u32)addr;
#if UINTPTR_MAX > 0xFFFFFFFFu
    o[TLUTOBJ_DATA_HI] = (u32)(addr >> 32);
#else
    o[TLUTOBJ_DATA_HI] = 0;
#endif
}

static const void* tlutobj_get_data_ptr(const u32* o) {
    uintptr_t addr = (uintptr_t)o[TLUTOBJ_DATA];
#if UINTPTR_MAX > 0xFFFFFFFFu
    addr |= (uintptr_t)o[TLUTOBJ_DATA_HI] << 32;
#endif
...
void GXLoadTexObj(void* obj, u32 id) {
    ...
    u32* o = (u32*)obj;
    void* image_ptr = texobj_get_image_ptr(o);
    uintptr_t image_ptr_key = (uintptr_t)image_ptr;
...
void GXLoadTlut(void* obj, u32 idx) {
    ...
    if (idx >= 16) return;
    u32* o = (u32*)obj;
    g_gx.tlut[idx].data = tlutobj_get_data_ptr(o);
...
void*  GXGetTexObjData(const void* obj)   { return texobj_get_image_ptr((const u32*)obj); }
