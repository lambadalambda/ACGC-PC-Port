...
check_contains "src/data/model/obj_station1_shadow.c" 'obj_station1_shadow_lowT_model\[6\]\.words\.w1 = pc_gbi_ptr_encode\(&obj_station1_shadow_v\[19\]\);' 'station1 shadow low vertex pointer patched'
check_contains "src/data/model/obj_station1_shadow.c" 'obj_station2_shadow_hi_model\[11\]\.words\.w1 = pc_gbi_ptr_encode\(&obj_station2_shadow_v\[32\]\);' 'station2 shadow second vertex pointer patched'
