...
check_contains "src/game/m_scene.c" 'size = PC_RUNTIME_U32_PTR\(\(\(\(uintptr_t\)play->object_exchange.max_ram_address -' 'initial exchange remaining size checked narrowing uses uintptr_t'
