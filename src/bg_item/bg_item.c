...
extern void pc_patch_obj_s_tree5_models(void);
extern void pc_patch_obj_s_tree5_apple_models(void);
...
static void bIT_patch_lp64_bg_item_models(void) {
    ...
    pc_patch_obj_s_tree5_models();
    pc_patch_obj_s_tree5_apple_models();
