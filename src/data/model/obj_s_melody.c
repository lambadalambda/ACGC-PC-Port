...
void pc_patch_obj_s_melody_models(void) {
    ...
    obj_s_melodyT_mat_model[1].words.w1 = pc_gbi_ptr_encode(obj_melody_pal);
    obj_s_melodyT_mat_model[2].words.w1 = pc_gbi_ptr_encode(obj_s_melody_tex);
    obj_s_melodyT_gfx_model[0].words.w1 = pc_gbi_ptr_encode(obj_s_melody_v);
