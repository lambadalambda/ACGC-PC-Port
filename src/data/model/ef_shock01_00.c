...
void pc_patch_ef_shock01_modelT(void) {
    ...
    ef_shock01_00_modelT[3].words.w1 = pc_gbi_ptr_encode(ef_shock01_0);
    ef_shock01_00_modelT[6].words.w1 = pc_gbi_ptr_encode(ef_shock01_00_v);
