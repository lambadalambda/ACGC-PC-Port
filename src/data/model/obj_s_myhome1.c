...
void pc_patch_obj_myhome_models(void) {
    ...
    obj_s_myhome1_window_model[3].words.w1 = pc_gbi_ptr_encode(obj_s_myhome1_window_txt);
    obj_s_myhome1_window_model[6].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome1_v[18]);
    obj_s_myhome1_light_model[3].words.w1 = SEGMENT_ADDR(ANIME_1_TXT_SEG, 0);
    obj_s_myhome1_light_model[4].words.w1 = pc_gbi_ptr_encode(obj_s_myhome1_t2_tex_txt);
    obj_s_myhome1_light_model[7].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome1_v[26]);
    obj_s_myhome1_t3_model[0].words.w1 = SEGMENT_ADDR(ANIME_1_TXT_SEG, 0);
    obj_s_myhome1_t3_model[1].words.w1 = pc_gbi_ptr_encode(obj_s_myhome1_t3_tex_txt);
    obj_s_myhome1_t3_model[4].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome1_v[38]);
    obj_s_myhome1_t3_model[10].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome1_v[70]);
    obj_s_myhome1_t2_model[0].words.w1 = SEGMENT_ADDR(ANIME_1_TXT_SEG, 0);
    obj_s_myhome1_t2_model[1].words.w1 = pc_gbi_ptr_encode(obj_s_myhome1_t2_tex_txt);
    obj_s_myhome1_t2_model[4].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome1_v[104]);
    obj_s_myhome1_t1_model[3].words.w1 = SEGMENT_ADDR(ANIME_1_TXT_SEG, 0);
    obj_s_myhome1_t1_model[4].words.w1 = pc_gbi_ptr_encode(obj_s_myhome1_t1_tex_txt);
    obj_s_myhome1_t1_model[8].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome1_v[98]);
    obj_s_myhome1_fuda_model[3].words.w1 = SEGMENT_ADDR(ANIME_1_TXT_SEG, 0);
    obj_s_myhome1_fuda_model[4].words.w1 = pc_gbi_ptr_encode(obj_s_myhome1_t2_tex_txt);
    obj_s_myhome1_fuda_model[8].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome1_v[116]);
    obj_s_myhome1_mark_model[3].words.w1 = SEGMENT_ADDR(ANIME_3_TXT_SEG, 0);
    obj_s_myhome1_mark_model[4].words.w1 = SEGMENT_ADDR(ANIME_2_TXT_SEG, 0);
    obj_s_myhome1_mark_model[8].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome1_v[4]);
    obj_s_myhome1_door_model[3].words.w1 = SEGMENT_ADDR(ANIME_1_TXT_SEG, 0);
    obj_s_myhome1_door_model[4].words.w1 = pc_gbi_ptr_encode(obj_s_myhome1_t3_tex_txt);
    obj_s_myhome1_door_model[8].words.w1 = pc_gbi_ptr_encode(obj_s_myhome1_v);
    obj_s_myhome1_kazamiB_model[3].words.w1 = SEGMENT_ADDR(ANIME_1_TXT_SEG, 0);
    obj_s_myhome1_kazamiB_model[4].words.w1 = pc_gbi_ptr_encode(obj_s_myhome1_t2_tex_txt);
    obj_s_myhome1_kazamiB_model[8].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome1_v[74]);
    obj_s_myhome1_kazamiA_model[3].words.w1 = SEGMENT_ADDR(ANIME_1_TXT_SEG, 0);
    obj_s_myhome1_kazamiA_model[4].words.w1 = pc_gbi_ptr_encode(obj_s_myhome1_t2_tex_txt);
    obj_s_myhome1_kazamiA_model[8].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome1_v[90]);

    obj_w_myhome1_window_model[3].words.w1 = pc_gbi_ptr_encode(obj_w_myhome1_window_txt);
    obj_w_myhome1_window_model[6].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome1_v[18]);
    obj_w_myhome1_light_model[3].words.w1 = SEGMENT_ADDR(ANIME_1_TXT_SEG, 0);
    obj_w_myhome1_light_model[4].words.w1 = pc_gbi_ptr_encode(obj_w_myhome1_t2_tex_txt);
    obj_w_myhome1_light_model[7].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome1_v[26]);
    obj_w_myhome1_t3_model[0].words.w1 = SEGMENT_ADDR(ANIME_1_TXT_SEG, 0);
    obj_w_myhome1_t3_model[1].words.w1 = pc_gbi_ptr_encode(obj_w_myhome1_t3_tex_txt);
    obj_w_myhome1_t3_model[4].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome1_v[38]);
    obj_w_myhome1_t3_model[10].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome1_v[70]);
    obj_w_myhome1_t2_model[0].words.w1 = SEGMENT_ADDR(ANIME_1_TXT_SEG, 0);
    obj_w_myhome1_t2_model[1].words.w1 = pc_gbi_ptr_encode(obj_w_myhome1_t2_tex_txt);
    obj_w_myhome1_t2_model[4].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome1_v[104]);
    obj_w_myhome1_t1_model[3].words.w1 = SEGMENT_ADDR(ANIME_1_TXT_SEG, 0);
    obj_w_myhome1_t1_model[4].words.w1 = pc_gbi_ptr_encode(obj_w_myhome1_t1_tex_txt);
    obj_w_myhome1_t1_model[8].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome1_v[98]);
    obj_w_myhome1_fuda_model[3].words.w1 = SEGMENT_ADDR(ANIME_1_TXT_SEG, 0);
    obj_w_myhome1_fuda_model[4].words.w1 = pc_gbi_ptr_encode(obj_w_myhome1_t2_tex_txt);
    obj_w_myhome1_fuda_model[8].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome1_v[116]);
    obj_w_myhome1_mark_model[3].words.w1 = SEGMENT_ADDR(ANIME_3_TXT_SEG, 0);
    obj_w_myhome1_mark_model[4].words.w1 = SEGMENT_ADDR(ANIME_2_TXT_SEG, 0);
    obj_w_myhome1_mark_model[8].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome1_v[4]);
    obj_w_myhome1_door_model[3].words.w1 = SEGMENT_ADDR(ANIME_1_TXT_SEG, 0);
    obj_w_myhome1_door_model[4].words.w1 = pc_gbi_ptr_encode(obj_w_myhome1_t3_tex_txt);
    obj_w_myhome1_door_model[8].words.w1 = pc_gbi_ptr_encode(obj_w_myhome1_v);
    obj_w_myhome1_kazamiB_model[3].words.w1 = SEGMENT_ADDR(ANIME_1_TXT_SEG, 0);
    obj_w_myhome1_kazamiB_model[4].words.w1 = pc_gbi_ptr_encode(obj_w_myhome1_t2_tex_txt);
    obj_w_myhome1_kazamiB_model[8].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome1_v[74]);
    obj_w_myhome1_kazamiA_model[3].words.w1 = SEGMENT_ADDR(ANIME_1_TXT_SEG, 0);
    obj_w_myhome1_kazamiA_model[4].words.w1 = pc_gbi_ptr_encode(obj_w_myhome1_t2_tex_txt);
    obj_w_myhome1_kazamiA_model[8].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome1_v[90]);

    obj_s_myhome4_window_model[3].words.w1 = pc_gbi_ptr_encode(obj_s_myhome4_window_txt);
    obj_s_myhome4_window_model[6].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome4_v[86]);
    obj_s_myhome4_t3_model[0].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    obj_s_myhome4_t3_model[1].words.w1 = pc_gbi_ptr_encode(obj_s_myhome4_t3_tex_txt);
    obj_s_myhome4_t3_model[4].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome4_v[42]);
    obj_s_myhome4_t3_model[10].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome4_v[74]);
    obj_s_myhome4_t2_model[0].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    obj_s_myhome4_t2_model[1].words.w1 = pc_gbi_ptr_encode(obj_s_myhome4_t2_tex_txt);
    obj_s_myhome4_t2_model[4].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome4_v[117]);
    obj_s_myhome4_t1_model[3].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    obj_s_myhome4_t1_model[4].words.w1 = pc_gbi_ptr_encode(obj_s_myhome4_t1_tex_txt);
    obj_s_myhome4_t1_model[8].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome4_v[132]);
    obj_s_myhome4_t1_model[15].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome4_v[164]);
    obj_s_myhome4_t1_model[21].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome4_v[194]);
    obj_s_myhome4_light_model[3].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    obj_s_myhome4_light_model[4].words.w1 = pc_gbi_ptr_encode(obj_s_myhome4_t1_tex_txt);
    obj_s_myhome4_light_model[7].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome4_v[94]);
    obj_s_myhome4_fuda_model[3].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    obj_s_myhome4_fuda_model[4].words.w1 = pc_gbi_ptr_encode(obj_s_myhome4_t1_tex_txt);
    obj_s_myhome4_fuda_model[8].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome4_v[78]);
    obj_s_myhome4_mark_model[3].words.w1 = SEGMENT_ADDR(0xA, 0x0);
    obj_s_myhome4_mark_model[4].words.w1 = SEGMENT_ADDR(0x9, 0x0);
    obj_s_myhome4_mark_model[8].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome4_v[4]);
    obj_s_myhome4_door_model[3].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    obj_s_myhome4_door_model[4].words.w1 = pc_gbi_ptr_encode(obj_s_myhome4_t3_tex_txt);
    obj_s_myhome4_door_model[8].words.w1 = pc_gbi_ptr_encode(obj_s_myhome4_v);
    obj_s_myhome4_kazamiB_model[3].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    obj_s_myhome4_kazamiB_model[4].words.w1 = pc_gbi_ptr_encode(obj_s_myhome4_t2_tex_txt);
    obj_s_myhome4_kazamiB_model[8].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome4_v[26]);
    obj_s_myhome4_kazamiA_model[3].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    obj_s_myhome4_kazamiA_model[4].words.w1 = pc_gbi_ptr_encode(obj_s_myhome4_t2_tex_txt);
    obj_s_myhome4_kazamiA_model[8].words.w1 = pc_gbi_ptr_encode(&obj_s_myhome4_v[18]);

    obj_w_myhome4_window_model[3].words.w1 = pc_gbi_ptr_encode(obj_w_myhome4_window_txt);
    obj_w_myhome4_window_model[6].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome4_v[86]);
    obj_w_myhome4_t3_model[0].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    obj_w_myhome4_t3_model[1].words.w1 = pc_gbi_ptr_encode(obj_w_myhome4_t3_tex_txt);
    obj_w_myhome4_t3_model[4].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome4_v[42]);
    obj_w_myhome4_t3_model[10].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome4_v[74]);
    obj_w_myhome4_t2_model[0].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    obj_w_myhome4_t2_model[1].words.w1 = pc_gbi_ptr_encode(obj_w_myhome4_t2_tex_txt);
    obj_w_myhome4_t2_model[4].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome4_v[117]);
    obj_w_myhome4_t1_model[3].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    obj_w_myhome4_t1_model[4].words.w1 = pc_gbi_ptr_encode(obj_w_myhome4_t1_tex_txt);
    obj_w_myhome4_t1_model[8].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome4_v[132]);
    obj_w_myhome4_t1_model[15].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome4_v[164]);
    obj_w_myhome4_t1_model[21].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome4_v[194]);
    obj_w_myhome4_light_model[3].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    obj_w_myhome4_light_model[4].words.w1 = pc_gbi_ptr_encode(obj_w_myhome4_t1_tex_txt);
    obj_w_myhome4_light_model[7].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome4_v[94]);
    obj_w_myhome4_fuda_model[3].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    obj_w_myhome4_fuda_model[4].words.w1 = pc_gbi_ptr_encode(obj_w_myhome4_t1_tex_txt);
    obj_w_myhome4_fuda_model[8].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome4_v[78]);
    obj_w_myhome4_mark_model[3].words.w1 = SEGMENT_ADDR(0xA, 0x0);
    obj_w_myhome4_mark_model[4].words.w1 = SEGMENT_ADDR(0x9, 0x0);
    obj_w_myhome4_mark_model[8].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome4_v[4]);
    obj_w_myhome4_door_model[3].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    obj_w_myhome4_door_model[4].words.w1 = pc_gbi_ptr_encode(obj_w_myhome4_t3_tex_txt);
    obj_w_myhome4_door_model[8].words.w1 = pc_gbi_ptr_encode(obj_w_myhome4_v);
    obj_w_myhome4_kazamiB_model[3].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    obj_w_myhome4_kazamiB_model[4].words.w1 = pc_gbi_ptr_encode(obj_w_myhome4_t2_tex_txt);
    obj_w_myhome4_kazamiB_model[8].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome4_v[26]);
    obj_w_myhome4_kazamiA_model[3].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    obj_w_myhome4_kazamiA_model[4].words.w1 = pc_gbi_ptr_encode(obj_w_myhome4_t2_tex_txt);
    obj_w_myhome4_kazamiA_model[8].words.w1 = pc_gbi_ptr_encode(&obj_w_myhome4_v[18]);
