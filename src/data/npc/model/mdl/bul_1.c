...
static void pc_patch_bul_1_models(void) {
    ...
    head_bul_model[3].words.w1 = SEGMENT_ADDR(0xB, 0x0);
    head_bul_model[7].words.w1 = pc_gbi_ptr_encode(&bul_1_v[0]);
    head_bul_model[15].words.w1 = pc_gbi_ptr_encode(&bul_1_v[19]);
    head_bul_model[23].words.w1 = SEGMENT_ADDR(0xB, 0x80);
    head_bul_model[28].words.w1 = pc_gbi_ptr_encode(&bul_1_v[46]);
    head_bul_model[31].words.w1 = SEGMENT_ADDR(0x9, 0x0);
    head_bul_model[38].words.w1 = SEGMENT_ADDR(0xB, 0x100);
    head_bul_model[40].words.w1 = pc_gbi_ptr_encode(&bul_1_v[67]);
    head_bul_model[51].words.w1 = SEGMENT_ADDR(0xB, 0x200);
    head_bul_model[53].words.w1 = pc_gbi_ptr_encode(&bul_1_v[93]);
    head_bul_model[58].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    Rarm2_bul_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x280);
    Rarm2_bul_model[3].words.w1 = pc_gbi_ptr_encode(&bul_1_v[155]);
    Rarm2_bul_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x2C0);
    Rarm2_bul_model[8].words.w1 = SEGMENT_ADDR(0xB, 0x300);
    Rarm2_bul_model[11].words.w1 = pc_gbi_ptr_encode(&bul_1_v[160]);
    Rarm1_bul_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x1C0);
    Rarm1_bul_model[3].words.w1 = pc_gbi_ptr_encode(&bul_1_v[176]);
    Rarm1_bul_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x280);
    Rarm1_bul_model[8].words.w1 = SEGMENT_ADDR(0xB, 0x300);
    Rarm1_bul_model[11].words.w1 = pc_gbi_ptr_encode(&bul_1_v[180]);
    Larm2_bul_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x200);
    Larm2_bul_model[3].words.w1 = pc_gbi_ptr_encode(&bul_1_v[119]);
    Larm2_bul_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x240);
    Larm2_bul_model[8].words.w1 = SEGMENT_ADDR(0xB, 0x300);
    Larm2_bul_model[11].words.w1 = pc_gbi_ptr_encode(&bul_1_v[124]);
    Larm1_bul_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x1C0);
    Larm1_bul_model[3].words.w1 = pc_gbi_ptr_encode(&bul_1_v[140]);
    Larm1_bul_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x200);
    Larm1_bul_model[8].words.w1 = SEGMENT_ADDR(0xB, 0x300);
    Larm1_bul_model[11].words.w1 = pc_gbi_ptr_encode(&bul_1_v[144]);
    chest_bul_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x0);
    chest_bul_model[3].words.w1 = pc_gbi_ptr_encode(&bul_1_v[191]);
    chest_bul_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x1C0);
    chest_bul_model[8].words.w1 = SEGMENT_ADDR(0xA, 0x0);
    chest_bul_model[11].words.w1 = pc_gbi_ptr_encode(&bul_1_v[198]);
    chest_bul_model[16].words.w1 = pc_gbi_ptr_encode(&bul_1_v[218]);
    tail1_bul_model[3].words.w1 = SEGMENT_ADDR(0xB, 0x380);
    tail1_bul_model[7].words.w1 = pc_gbi_ptr_encode(&bul_1_v[242]);
    tail2_bul_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x140);
    tail2_bul_model[3].words.w1 = pc_gbi_ptr_encode(&bul_1_v[228]);
    tail2_bul_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x180);
    tail2_bul_model[8].words.w1 = SEGMENT_ADDR(0xB, 0x380);
    tail2_bul_model[11].words.w1 = pc_gbi_ptr_encode(&bul_1_v[232]);
    Rfoot2_bul_model[0].words.w1 = SEGMENT_ADDR(0xD, 0xC0);
    Rfoot2_bul_model[3].words.w1 = pc_gbi_ptr_encode(&bul_1_v[290]);
    Rfoot2_bul_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x100);
    Rfoot2_bul_model[8].words.w1 = SEGMENT_ADDR(0xB, 0x300);
    Rfoot2_bul_model[11].words.w1 = pc_gbi_ptr_encode(&bul_1_v[295]);
    Rfoot1_bul_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x0);
    Rfoot1_bul_model[3].words.w1 = pc_gbi_ptr_encode(&bul_1_v[311]);
    Rfoot1_bul_model[4].words.w1 = SEGMENT_ADDR(0xD, 0xC0);
    Rfoot1_bul_model[8].words.w1 = SEGMENT_ADDR(0xB, 0x300);
    Rfoot1_bul_model[11].words.w1 = pc_gbi_ptr_encode(&bul_1_v[317]);
    Lfoot2_bul_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x40);
    Lfoot2_bul_model[3].words.w1 = pc_gbi_ptr_encode(&bul_1_v[250]);
    Lfoot2_bul_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x80);
    Lfoot2_bul_model[8].words.w1 = SEGMENT_ADDR(0xB, 0x300);
    Lfoot2_bul_model[11].words.w1 = pc_gbi_ptr_encode(&bul_1_v[255]);
    Lfoot1_bul_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x0);
    Lfoot1_bul_model[3].words.w1 = pc_gbi_ptr_encode(&bul_1_v[271]);
    Lfoot1_bul_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x40);
    Lfoot1_bul_model[8].words.w1 = SEGMENT_ADDR(0xB, 0x300);
    Lfoot1_bul_model[11].words.w1 = pc_gbi_ptr_encode(&bul_1_v[277]);
    base_bul_model[3].words.w1 = SEGMENT_ADDR(0xB, 0x300);
    base_bul_model[7].words.w1 = pc_gbi_ptr_encode(&bul_1_v[330]);
    base_bul_model[9].words.w1 = SEGMENT_ADDR(0xA, 0x0);
    base_bul_model[15].words.w1 = SEGMENT_ADDR(0xB, 0x300);
