...
static void pc_patch_cat_1_models(void) {
    ...
    head_cat_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x1C0);
    head_cat_model[3].words.w1 = pc_gbi_ptr_encode(&cat_1_v[0]);
    head_cat_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x300);
    head_cat_model[8].words.w1 = SEGMENT_ADDR(0xA, 0x0);
    head_cat_model[12].words.w1 = pc_gbi_ptr_encode(&cat_1_v[6]);
    head_cat_model[16].words.w1 = SEGMENT_ADDR(0x8, 0x0);
    head_cat_model[18].words.w1 = pc_gbi_ptr_encode(&cat_1_v[19]);
    head_cat_model[24].words.w1 = SEGMENT_ADDR(0x9, 0x0);
    head_cat_model[31].words.w1 = SEGMENT_ADDR(0xB, 0x0);
    head_cat_model[33].words.w1 = pc_gbi_ptr_encode(&cat_1_v[50]);
    Rarm2_cat_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x280);
    Rarm2_cat_model[3].words.w1 = pc_gbi_ptr_encode(&cat_1_v[108]);
    Rarm2_cat_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x2C0);
    Rarm2_cat_model[8].words.w1 = SEGMENT_ADDR(0xB, 0x280);
    Rarm2_cat_model[11].words.w1 = pc_gbi_ptr_encode(&cat_1_v[113]);
    Rarm1_cat_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x1C0);
    Rarm1_cat_model[3].words.w1 = pc_gbi_ptr_encode(&cat_1_v[129]);
    Rarm1_cat_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x280);
    Rarm1_cat_model[8].words.w1 = SEGMENT_ADDR(0xB, 0x280);
    Rarm1_cat_model[11].words.w1 = pc_gbi_ptr_encode(&cat_1_v[133]);
    Larm2_cat_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x200);
    Larm2_cat_model[3].words.w1 = pc_gbi_ptr_encode(&cat_1_v[72]);
    Larm2_cat_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x240);
    Larm2_cat_model[8].words.w1 = SEGMENT_ADDR(0xB, 0x200);
    Larm2_cat_model[11].words.w1 = pc_gbi_ptr_encode(&cat_1_v[77]);
    Larm1_cat_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x1C0);
    Larm1_cat_model[3].words.w1 = pc_gbi_ptr_encode(&cat_1_v[93]);
    Larm1_cat_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x200);
    Larm1_cat_model[8].words.w1 = SEGMENT_ADDR(0xB, 0x200);
    Larm1_cat_model[11].words.w1 = pc_gbi_ptr_encode(&cat_1_v[97]);
    chest_cat_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x0);
    chest_cat_model[3].words.w1 = pc_gbi_ptr_encode(&cat_1_v[144]);
    chest_cat_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x1C0);
    chest_cat_model[8].words.w1 = SEGMENT_ADDR(0xA, 0x0);
    chest_cat_model[12].words.w1 = pc_gbi_ptr_encode(&cat_1_v[151]);
    tail1_cat_model[3].words.w1 = SEGMENT_ADDR(0xB, 0x300);
    tail1_cat_model[7].words.w1 = pc_gbi_ptr_encode(&cat_1_v[195]);
    tail2_cat_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x140);
    tail2_cat_model[3].words.w1 = pc_gbi_ptr_encode(&cat_1_v[171]);
    tail2_cat_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x180);
    tail2_cat_model[8].words.w1 = SEGMENT_ADDR(0xB, 0x300);
    tail2_cat_model[11].words.w1 = pc_gbi_ptr_encode(&cat_1_v[175]);
    Rfoot2_cat_model[0].words.w1 = SEGMENT_ADDR(0xD, 0xC0);
    Rfoot2_cat_model[3].words.w1 = pc_gbi_ptr_encode(&cat_1_v[256]);
    Rfoot2_cat_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x100);
    Rfoot2_cat_model[8].words.w1 = SEGMENT_ADDR(0xB, 0x200);
    Rfoot2_cat_model[11].words.w1 = pc_gbi_ptr_encode(&cat_1_v[261]);
    Rfoot1_cat_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x0);
    Rfoot1_cat_model[3].words.w1 = pc_gbi_ptr_encode(&cat_1_v[281]);
    Rfoot1_cat_model[4].words.w1 = SEGMENT_ADDR(0xD, 0xC0);
    Rfoot1_cat_model[8].words.w1 = SEGMENT_ADDR(0xA, 0x0);
    Rfoot1_cat_model[12].words.w1 = pc_gbi_ptr_encode(&cat_1_v[287]);
    Rfoot1_cat_model[15].words.w1 = SEGMENT_ADDR(0xB, 0x200);
    Rfoot1_cat_model[19].words.w1 = SEGMENT_ADDR(0xA, 0x0);
    Lfoot2_cat_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x40);
    Lfoot2_cat_model[3].words.w1 = pc_gbi_ptr_encode(&cat_1_v[203]);
    Lfoot2_cat_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x80);
    Lfoot2_cat_model[8].words.w1 = SEGMENT_ADDR(0xB, 0x280);
    Lfoot2_cat_model[11].words.w1 = pc_gbi_ptr_encode(&cat_1_v[208]);
    Lfoot1_cat_model[0].words.w1 = SEGMENT_ADDR(0xD, 0x0);
    Lfoot1_cat_model[3].words.w1 = pc_gbi_ptr_encode(&cat_1_v[228]);
    Lfoot1_cat_model[4].words.w1 = SEGMENT_ADDR(0xD, 0x40);
    Lfoot1_cat_model[8].words.w1 = SEGMENT_ADDR(0xA, 0x0);
    Lfoot1_cat_model[12].words.w1 = pc_gbi_ptr_encode(&cat_1_v[234]);
    Lfoot1_cat_model[15].words.w1 = SEGMENT_ADDR(0xB, 0x280);
    Lfoot1_cat_model[19].words.w1 = SEGMENT_ADDR(0xA, 0x0);
    base_cat_model[3].words.w1 = SEGMENT_ADDR(0xA, 0x0);
    base_cat_model[8].words.w1 = pc_gbi_ptr_encode(&cat_1_v[309]);
