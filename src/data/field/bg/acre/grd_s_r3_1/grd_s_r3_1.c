...
static void pc_patch_grd_s_r3_1_model(void) {
    ...
    grd_s_r3_1_model[3].words.w1 = pc_gbi_ptr_encode(bush_pal_dummy);
    grd_s_r3_1_model[4].words.w1 = pc_gbi_ptr_encode(bush_a_tex_dummy);
    grd_s_r3_1_model[8].words.w1 = pc_gbi_ptr_encode(&grd_s_r3_1_v[176]);
    grd_s_r3_1_model[15].words.w1 = pc_gbi_ptr_encode(earth_pal_dummy);
    grd_s_r3_1_model[16].words.w1 = pc_gbi_ptr_encode(grass_tex_dummy);
    grd_s_r3_1_model[18].words.w1 = pc_gbi_ptr_encode(&grd_s_r3_1_v[0]);
    grd_s_r3_1_model[26].words.w1 = pc_gbi_ptr_encode(&grd_s_r3_1_v[32]);
    grd_s_r3_1_model[33].words.w1 = pc_gbi_ptr_encode(&grd_s_r3_1_v[62]);
    grd_s_r3_1_model[36].words.w1 = pc_gbi_ptr_encode(earth_tex_dummy);
    grd_s_r3_1_model[38].words.w1 = pc_gbi_ptr_encode(&grd_s_r3_1_v[72]);
    grd_s_r3_1_model[44].words.w1 = pc_gbi_ptr_encode(cliff_pal_dummy);
    grd_s_r3_1_model[45].words.w1 = pc_gbi_ptr_encode(river_tex_dummy);
    grd_s_r3_1_model[47].words.w1 = pc_gbi_ptr_encode(&grd_s_r3_1_v[103]);
    grd_s_r3_1_model[56].words.w1 = pc_gbi_ptr_encode(&grd_s_r3_1_v[135]);
    grd_s_r3_1_model[60].words.w1 = pc_gbi_ptr_encode(bush_pal_dummy);
    grd_s_r3_1_model[61].words.w1 = pc_gbi_ptr_encode(bush_b_tex_dummy);
    grd_s_r3_1_model[63].words.w1 = pc_gbi_ptr_encode(&grd_s_r3_1_v[146]);

    grd_s_r3_1_modelT[5].words.w1 = pc_gbi_ptr_encode(water_1_tex_dummy);
    grd_s_r3_1_modelT[7].words.w1 = pc_gbi_ptr_encode(water_2_tex_dummy);
    grd_s_r3_1_modelT[9].words.w1 = SEGMENT_ADDR(G_MWO_SEGMENT_8, 0);
    grd_s_r3_1_modelT[11].words.w1 = pc_gbi_ptr_encode(&grd_s_r3_1_v[206]);
