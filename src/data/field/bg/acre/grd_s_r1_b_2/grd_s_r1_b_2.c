...
void pc_patch_grd_s_r1_b_2_model(void) {
    ...
    grd_s_r1_b_2_modelT[5].words.w1 = pc_gbi_ptr_encode(water_1_tex_dummy);
    grd_s_r1_b_2_modelT[7].words.w1 = pc_gbi_ptr_encode(water_2_tex_dummy);
    grd_s_r1_b_2_modelT[9].words.w1 = (unsigned int)(uintptr_t)(0x08000000);
    grd_s_r1_b_2_modelT[11].words.w1 = pc_gbi_ptr_encode(&grd_s_r1_b_2_v[260]);
    grd_s_r1_b_2_model[3].words.w1 = pc_gbi_ptr_encode(bush_pal_dummy);
    grd_s_r1_b_2_model[4].words.w1 = pc_gbi_ptr_encode(bush_a_tex_dummy);
    grd_s_r1_b_2_model[8].words.w1 = pc_gbi_ptr_encode(&grd_s_r1_b_2_v[209]);
    grd_s_r1_b_2_model[11].words.w1 = pc_gbi_ptr_encode(bridge_2_pal_dummy);
    grd_s_r1_b_2_model[12].words.w1 = pc_gbi_ptr_encode(bridge_2_tex_dummy);
    grd_s_r1_b_2_model[14].words.w1 = pc_gbi_ptr_encode(&grd_s_r1_b_2_v[222]);
    grd_s_r1_b_2_model[21].words.w1 = pc_gbi_ptr_encode(&grd_s_r1_b_2_v[252]);
    grd_s_r1_b_2_model[25].words.w1 = pc_gbi_ptr_encode(earth_pal_dummy);
    grd_s_r1_b_2_model[26].words.w1 = pc_gbi_ptr_encode(grass_tex_dummy);
    grd_s_r1_b_2_model[28].words.w1 = pc_gbi_ptr_encode(&grd_s_r1_b_2_v[0]);
    grd_s_r1_b_2_model[35].words.w1 = pc_gbi_ptr_encode(&grd_s_r1_b_2_v[32]);
    grd_s_r1_b_2_model[41].words.w1 = pc_gbi_ptr_encode(&grd_s_r1_b_2_v[63]);
    grd_s_r1_b_2_model[45].words.w1 = pc_gbi_ptr_encode(earth_tex_dummy);
    grd_s_r1_b_2_model[47].words.w1 = pc_gbi_ptr_encode(&grd_s_r1_b_2_v[79]);
    grd_s_r1_b_2_model[53].words.w1 = pc_gbi_ptr_encode(&grd_s_r1_b_2_v[110]);
    grd_s_r1_b_2_model[58].words.w1 = pc_gbi_ptr_encode(&grd_s_r1_b_2_v[142]);
    grd_s_r1_b_2_model[61].words.w1 = pc_gbi_ptr_encode(bush_pal_dummy);
    grd_s_r1_b_2_model[62].words.w1 = pc_gbi_ptr_encode(bush_b_tex_dummy);
    grd_s_r1_b_2_model[64].words.w1 = pc_gbi_ptr_encode(&grd_s_r1_b_2_v[154]);
    grd_s_r1_b_2_model[67].words.w1 = pc_gbi_ptr_encode(cliff_pal_dummy);
    grd_s_r1_b_2_model[68].words.w1 = pc_gbi_ptr_encode(river_tex_dummy);
    grd_s_r1_b_2_model[70].words.w1 = pc_gbi_ptr_encode(&grd_s_r1_b_2_v[167]);
    grd_s_r1_b_2_model[79].words.w1 = pc_gbi_ptr_encode(&grd_s_r1_b_2_v[199]);
