...
static void pc_patch_grd_s_r4_2_model(void) {
    ...
    grd_s_r4_2_modelT[5].words.w1 = pc_gbi_ptr_encode(water_1_tex_dummy);
    grd_s_r4_2_modelT[7].words.w1 = pc_gbi_ptr_encode(water_2_tex_dummy);
    grd_s_r4_2_modelT[9].words.w1 = (unsigned int)(uintptr_t)(0x08000000);
    grd_s_r4_2_modelT[11].words.w1 = pc_gbi_ptr_encode(&grd_s_r4_2_v[194]);
    grd_s_r4_2_model[3].words.w1 = pc_gbi_ptr_encode(earth_pal_dummy);
    grd_s_r4_2_model[4].words.w1 = pc_gbi_ptr_encode(grass_tex_dummy);
    grd_s_r4_2_model[8].words.w1 = pc_gbi_ptr_encode(&grd_s_r4_2_v[0]);
    grd_s_r4_2_model[15].words.w1 = pc_gbi_ptr_encode(&grd_s_r4_2_v[30]);
    grd_s_r4_2_model[22].words.w1 = pc_gbi_ptr_encode(&grd_s_r4_2_v[60]);
    grd_s_r4_2_model[24].words.w1 = pc_gbi_ptr_encode(earth_tex_dummy);
    grd_s_r4_2_model[26].words.w1 = pc_gbi_ptr_encode(&grd_s_r4_2_v[64]);
    grd_s_r4_2_model[31].words.w1 = pc_gbi_ptr_encode(&grd_s_r4_2_v[94]);
    grd_s_r4_2_model[37].words.w1 = pc_gbi_ptr_encode(&grd_s_r4_2_v[125]);
    grd_s_r4_2_model[41].words.w1 = pc_gbi_ptr_encode(cliff_pal_dummy);
    grd_s_r4_2_model[42].words.w1 = pc_gbi_ptr_encode(river_tex_dummy);
    grd_s_r4_2_model[44].words.w1 = pc_gbi_ptr_encode(&grd_s_r4_2_v[144]);
    grd_s_r4_2_model[52].words.w1 = pc_gbi_ptr_encode(&grd_s_r4_2_v[176]);
