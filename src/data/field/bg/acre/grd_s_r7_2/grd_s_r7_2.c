...
void pc_patch_grd_s_r7_2_model(void) {
    ...
    grd_s_r7_2_modelT[5].words.w1 = pc_gbi_ptr_encode(water_1_tex_dummy);
    grd_s_r7_2_modelT[7].words.w1 = pc_gbi_ptr_encode(water_2_tex_dummy);
    grd_s_r7_2_modelT[9].words.w1 = (unsigned int)(uintptr_t)(0x08000000);
    grd_s_r7_2_modelT[11].words.w1 = pc_gbi_ptr_encode(&grd_s_r7_2_v[167]);
    grd_s_r7_2_model[3].words.w1 = pc_gbi_ptr_encode(earth_pal_dummy);
    grd_s_r7_2_model[4].words.w1 = pc_gbi_ptr_encode(grass_tex_dummy);
    grd_s_r7_2_model[8].words.w1 = pc_gbi_ptr_encode(&grd_s_r7_2_v[0]);
    grd_s_r7_2_model[17].words.w1 = pc_gbi_ptr_encode(&grd_s_r7_2_v[32]);
    grd_s_r7_2_model[22].words.w1 = pc_gbi_ptr_encode(earth_tex_dummy);
    grd_s_r7_2_model[24].words.w1 = pc_gbi_ptr_encode(&grd_s_r7_2_v[56]);
    grd_s_r7_2_model[31].words.w1 = pc_gbi_ptr_encode(&grd_s_r7_2_v[88]);
    grd_s_r7_2_model[37].words.w1 = pc_gbi_ptr_encode(cliff_pal_dummy);
    grd_s_r7_2_model[38].words.w1 = pc_gbi_ptr_encode(river_tex_dummy);
    grd_s_r7_2_model[40].words.w1 = pc_gbi_ptr_encode(&grd_s_r7_2_v[113]);
    grd_s_r7_2_model[49].words.w1 = pc_gbi_ptr_encode(&grd_s_r7_2_v[145]);
